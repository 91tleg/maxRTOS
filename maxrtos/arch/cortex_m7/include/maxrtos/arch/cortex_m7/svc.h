...
typedef enum
{
    ...
    MAXRTOS_SVC_PERIODIC_WAIT,
    MAXRTOS_SVC_MUTEX_LOCK,
    MAXRTOS_SVC_MUTEX_UNLOCK,
    MAXRTOS_SVC_SEMAPHORE_WAIT,
    MAXRTOS_SVC_SEMAPHORE_SIGNAL,
    MAXRTOS_SVC_SEMAPHORE_STATUS,
    MAXRTOS_SVC_BUFFER_SEND,
    MAXRTOS_SVC_BUFFER_RECEIVE,
    MAXRTOS_SVC_BUFFER_STATUS,
